	...
	<body>	
		<div class="container">
			<div class="row">
			    ...
			    <div class="col-sm-9">
			     <jsp:include page="fragment/home/userProfile.jsp"></jsp:include>
			     <jsp:include page="fragment/home/news.jsp"></jsp:include>
			     <jsp:include page="fragment/home/matchData.jsp"></jsp:include>
			    </div>
